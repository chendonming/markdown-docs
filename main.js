document.addEventListener('DOMContentLoaded', () => {
    ...
    async function handleRoute() {
        ...
        if (file && file !== currentFile) { await loadMarkdownFile(file); } else if (!file) { contentAreaElement.innerHTML = `<h2>欢迎！</h2><p>请从左侧选择一个文档进行查看。</p>`; currentFile = null; updateToc(); }
